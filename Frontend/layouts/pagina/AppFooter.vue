...
<template>
    <footer class="max-w-screen-xl px-4 py-5 mx-auto text-gray-500 bg-white">
        <div class="max-w-lg sm:mx-auto sm:text-center">
            <img src="https://www.floatui.com/logo.svg" class="w-32 sm:mx-auto" />
            <p class="leading-relaxed mt-2 text-[15px]">Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
        </div>
        ...
        <div class="items-center justify-between mt-8 sm:flex">
            <div class="mt-4 sm:mt-0">&copy; 2022 Float UI All rights reserved.</div>
            <div class="mt-6 sm:mt-0">
                <ul class="flex items-center space-x-6">
                    <li class="flex items-center justify-center h-12 border rounded-full w-14">
                        <a href="javascript:void()" class="flex items-center justify-center">
                            <svg class="w-10 h-10 text-blue-400 svg-icon" viewBox="0 0 20 20">
                                <path
                                    fill="none"
                    ...
                    <li class="flex items-center justify-center h-12 border rounded-full w-14">
                        <a href="javascript:void()" class="flex items-center justify-center">
                            <svg class="w-10 h-10 text-blue-700 svg-icon" viewBox="0 0 20 20">
                    ...
                    <li class="flex items-center justify-center h-12 border rounded-full w-14" >
                        <a href="javascript:void()" class="flex items-center justify-center">
                            <svg class="w-10 h-10 text-blue-500 svg-icon" viewBox="0 0 20 20">
                                <path
                                    fill="none"
                    ...
                    <li class="flex items-center justify-center h-12 border rounded-full w-14">
                        <a href="javascript:void()" class="flex items-center justify-center">
                            <svg class="w-10 h-10 text-red-600 svg-icon" viewBox="0 0 20 20">
                                <path
                                    fill="none"
                            ...
                            <div class="flex gap-x-3 divide-amber-50"></div>
                        </a>
                    </li>
                </ul>
            </div>
