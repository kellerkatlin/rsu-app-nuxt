        ...
        <div class="col-12">
            <div class="card">
                ...
                >
                    ...
                    <Column field="attributes.Apellido" header="Cantidad" :sortable="true" headerStyle="width:14%; min-width:10rem;">
                        <template #body="slotProps">
                            <span class="p-column-title">Cantidad</span>
                           {{ slotProps.data.attributes.voluntarios.data.length}}
                        </template>d
                    </Column>
                    <Column headerStyle="min-width:10rem;">
                        <template #body="slotProps">
                            <Button icon="pi pi-pencil" class="p-button-rounded p-button-success mr-2" @click="editEvento(slotProps.data.id)" />
                            <Button icon="pi pi-trash" class="p-button-rounded p-button-warning mt-2" @click="confirmDeleteEvento(slotProps.data.id)" />
                        </template>
                    </Column>
                </DataTable>
                ...
                <Dialog v-if="evento" v-model:visible="eventoDialog" :modal="true" :style="{ width: '50vw' }" :closable="false">
                    <form @submit.prevent="isUpdateOperation ? updateEvento() : createEvento()">
                        ...
                        <div class="field">
                            ...
                            <Textarea id="cantidad" v-model="evento.attributes.Apellido" required="true" rows="3" cols="20" />
                        </div>
